...
public class DanhMuc_QuanLy extends javax.swing.JFrame {

    public DanhMuc_QuanLy() {
        initComponents();
    ...
    private void initComponents() {
        ...
        btnHoaDon.setIcon(new javax.swing.ImageIcon(getClass().getResource("/IMG/chart-icon.png"))); // NOI18N
        ...
        btnCaTruc.setIcon(new javax.swing.ImageIcon(getClass().getResource("/IMG/Document-icon.png"))); // NOI18N
        ...
        btnCaNhan.setIcon(new javax.swing.ImageIcon(getClass().getResource("/IMG/Slideshare-icon.png"))); // NOI18N
        ...
        btnHuongDan1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/IMG/User-Administrator-Blue-icon (1).png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DanhMuc_QuanLy().setVisible(true);
            }
        });
    }
